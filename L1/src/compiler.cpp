...
int main(
   ...
   */
  if (verbose){
    std::cerr << "EntryPoint = " << p.entryPointLabel << '\n';
    for (auto f : p.functions){
      std::cerr << "Function name = " << f->name << "\n";
      std::cerr << "    #arguments = " << f->arguments << "\n";
      std::cerr << "    #locals = " << f->locals << "\n";
      std::cerr << "    #instructions = " << f->instructions.size() << "\n";
      //TODO
    }
  }
